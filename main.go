...
func main() {
	...
	r.SetHTMLTemplate(template.Must(template.New("").ParseGlob("views/*.html")))
	...
	r.GET("/protected", func(c *gin.Context) {
		...
		c.HTML(200, "protected.html", gin.H{
			"username": username,
			"role":     role,
		})
	})
	...
	r.POST("/iso", controllers.CreateIso)
	r.GET("/iso/:id", controllers.PostsShow)
