...
func CreateIso(c *gin.Context) {
	...
	if result.Error != nil {
		c.Status(400)
		c.JSON(400, gin.H{"error": "Failed to create Iso: " + result.Error.Error()})
		return
	}
...
func IsoDelete(c *gin.Context) {
	...
	initializers.DB.Delete(&models.Iso{}, id)
